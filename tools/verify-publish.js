...
const checks = [
  ...
  ['ZH homepage article count 50', zhIdx.includes('>50<')],
  ['EN homepage article count 50', enIdx.includes('>50<')],
  ['ZH archive has new slug', zhArc.includes(slug)],
  ['EN archive has new slug', enArc.includes(slug)],
  ['ZH archive counter 50', zhArc.includes('共 50 篇')],
  ['EN archive counter 50', enArc.includes('50 articles')],
